"""
migrate_to_supabase.py — copy data/sqlite/shop.db → Supabase Postgres (optional; prefer tools/scripts/sqlite_to_postgres.py)
...
FROM REPO ROOT:
  export DATABASE_URL='postgresql://...@....pooler.supabase.com:5432/postgres?sslmode=require'
    python3 tools/scripts/migrate_to_supabase.py
...
Before running: apply infra/supabase/migrations/20250402120000_shop_schema.sql in the SQL Editor.
"""
